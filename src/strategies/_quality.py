...
BLACKLIST_INDUSTRIES = frozenset([
    ...
    "证券", "银行", "保险", "多元金融",
    # 地产装修
    "区域地产", "全国地产", "房产服务", "园区开发", "装修装饰", "房地产",
    # 消费品杂项
    "食品", "家用电器", "服饰", "家居用品", "百货", "超市连锁",
    "文教休闲", "酒店餐饮", "旅游景点", "旅游服务", "消费电子",
    # 农业
    "农药化肥", "农业综合", "饲料", "种植业", "渔业", "林业",
    # 交通运输
    "航空", "仓储物流", "运输设备", "水运", "港口", "铁路",
    "机场", "公路", "空运", "公共交通", "路桥", "轨道交通", "轨交",
    # 周边消费/媒体（横盘策略实测后剔除小众非主线行业，2026-05-19）
    "纺织", "广告包装", "商贸代理", "出版业", "影视音像",
    # 概念炒作板块（2026-06-17 回测证实胜率为0，直接过滤）
    "机器人", "工业机器人", "人形机器人", "减速器", "伺服", "电机",
    "AI应用", "AI服务", "AI平台", "大模型", "元宇宙", "VR", "AR",
    "3D视觉", "视觉检测",  # 3D视觉偏软件算法
    # 通信：只过滤设备商/运营商，保留光纤/光模块硬件制造
    "通信设备", "通信运营", "网络设备", "无线设备",
    # 软件：轻资产，不符合硬科技投资逻辑
    "软件", "软件开发", "软件服务", "应用软件", "系统软件", "游戏",
    # 医药：创新药周期长、政策风险高，不符合硬科技制造业逻辑
    "创新药", "医药", "生物医药", "中药",
    # 新能源：过滤终端应用/政策驱动，保留AI算力基础设施（2026-06-17）
    "光伏组件", "逆变器", "光伏电站", "风电", "风机",
    "动力电池", "新能源车", "整车", "汽车", "充电桩",
    # 保留：电力设备、储能系统、锂电材料（六氟、电解液）作为AI算力卖铲子
    # 环保/公用事业：非硬科技核心，偏应用端
    "环保", "污水处理", "固废处理", "水务", "燃气", "电力", "公用事业",
    # 传统周期/资源：非科技制造业
    "钢铁", "煤炭", "有色", "化工", "水泥", "建材", "玻璃", "造纸",
    # 教育/其他服务
    "教育", "培训", "传媒",
])
