...
Usage:
  python src/backtest/etf.py                               # 12 期 × 10d 前向
  python src/backtest/etf.py --periods 16 --fwd 5         # 16 期，5 日收益
  python src/backtest/etf.py --top 30 --out data/etf_backtest_16p.json
  python src/backtest/etf.py --universe my_etfs.json --periods 8
"""
