...
ALL_TASKS: list[dict[str, Any]] = [
    ...
    {"name": "chip_CadScan",      "time": "20:30", "desc": "筹码扫描",           "push": False, "slot": "cad_scan",       "disabled": False, "display": True},
    {"name": "evening_Strategy",  "time": "21:00", "desc": "多策略汇总·晚间",    "push": False, "slot": "evening_strategy","disabled": False, "display": True},
