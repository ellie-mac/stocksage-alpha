...
**A-share multi-factor alpha engine** — a 33-factor scoring system for systematic stock selection in Chinese equity markets.

## Overview

stocksage-alpha scores individual A-share stocks across 33 factors spanning fundamentals, technicals, sentiment, and market structure. Each factor produces independent **buy** and **sell** scores, enabling nuanced signal separation rather than a single net score.
...
See [FACTORS.md](FACTORS.md) for full documentation of all 33 factors including scoring logic, cross-rules, and key principles — in both Chinese and English.
